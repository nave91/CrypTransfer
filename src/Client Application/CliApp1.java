...
import java.io.*;
/**
 * Summary description for ClientApp
 *
 */
public class CliApp1 extends JFrame
{
	...
	private JLabel jLabel401;
	private JLabel jLabel501;
	private JLabel jLabel601;
	private JLabel jLabel701;
	private JLabel jLabel801;
	private JLabel jLabel901;
	private JLabel jLabel1001;
	private JLabel jLabel1101;
	private JLabel jLabel1201;*/
	//-----
			...
			FileInputStream fis=new FileInputStream("LGAddress.txt");
				...
				/*	downSer=new ServerSocket(9100);
					while(true)
					{
						...
						{
							jLabel101.setText(filename[0]);
							jLabel201.setText(filename[1]);
							jLabel301.setText(filename[2]);
							jLabel401.setText(filename[3]);
							jLabel501.setText(filename[4]);
							//jLabel601.setText(filename[5]);
						}
						else if(filename.length==6)
						{
							...
							jLabel501.setText(filename[4]);
							jLabel601.setText(filename[5]);
							//jLabel701.setText(filename[6]);
						}
						jLabel701.setText(filename[6]);
						jLabel801.setText(filename[7]);
						jLabel901.setText(filename[8]);
						jLabel1001.setText(filename[9]);
						jLabel1101.setText(filename[10]);
						jLabel1201.setText(filename[11]);
	...
	/*	jLabel101 = new JLabel();
		...
		jLabel101.setFont(new Font("Franklin Gothic Medium Cond",Font.BOLD,14));
		jLabel201 = new JLabel();
		jLabel201.setFont(new Font("Franklin Gothic Medium Cond",Font.BOLD,14));
		jLabel301 = new JLabel();
		jLabel301.setFont(new Font("Franklin Gothic Medium Cond",Font.BOLD,14));
		jLabel401 = new JLabel();
		jLabel401.setFont(new Font("Franklin Gothic Medium Cond",Font.BOLD,14));
		jLabel501 = new JLabel();
		jLabel501.setFont(new Font("Franklin Gothic Medium Cond",Font.BOLD,14));
		jLabel601 = new JLabel();
		jLabel601.setFont(new Font("Franklin Gothic Medium Cond",Font.BOLD,14));
		jLabel701 = new JLabel();
		jLabel701.setFont(new Font("Franklin Gothic Medium Cond",Font.BOLD,14));
		jLabel801 = new JLabel();
		jLabel801.setFont(new Font("Franklin Gothic Medium Cond",Font.BOLD,14));
		jLabel901 = new JLabel();
		jLabel901.setFont(new Font("Franklin Gothic Medium Cond",Font.BOLD,14));
		jLabel1001 = new JLabel();
		jLabel1001.setFont(new Font("Franklin Gothic Medium Cond",Font.BOLD,14));
		jLabel1101 = new JLabel();
		jLabel1101.setFont(new Font("Franklin Gothic Medium Cond",Font.BOLD,14));
		jLabel1201 = new JLabel();
		jLabel1201.setFont(new Font("Franklin Gothic Medium Cond",Font.BOLD,14));
*/

		jLabel2 = new JLabel();
		jLabel21 = new JLabel();
		jPanel1 = new JPanel();
		String[] label1={"Java Basics","J2EE","Java FX","Servlets","Oops","Jsp","Struts"};
	...
	public void mouseExited(java.awt.event.MouseEvent evt) {
		...
		//addComponent(jPanel2, jLabel4, 82,164,102,23);
		//addComponent(jPanel2, jRadioButton1, 176,220,150,24);
		//addComponent(jPanel2, jRadioButton2, 175,253,150,24);
		//addComponent(jPanel2, jTextField1, 245,88,153,25);
		//addComponent(jPanel2, jTextField2, 244,155,153,25);
		//addComponent(jPanel2, jButton1, 186,300,83,32);
		//addComponent(jPanel2, jButton2, 276,300,83,32);
		//
		// ClientApp
		//
		...
		//jButton1.setForeground(new Color(18,200,252));
		//jButton2.setForeground(new Color(18,200,252));
